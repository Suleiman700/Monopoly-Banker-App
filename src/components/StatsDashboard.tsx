...
export function StatsDashboard({ initialTransactions, players, initialDiceRolls, gameId }: StatsDashboardProps) {
  ...
  const filteredData = useMemo(() => {
    ...
    const passGoCount = transactions.filter(t => t.reason.toLowerCase().includes('pass go')).length;
